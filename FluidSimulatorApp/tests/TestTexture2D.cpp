...
namespace test {
	...
	TestTexture2D::TestTexture2D(unsigned int * heightPtr, unsigned int * widthPtr)
		: Test(heightPtr, widthPtr), m_Proj(glm::ortho(0.f, 960.f, 0.f, 540.f, -1.0f, 1.0f)),
	...
	void TestTexture2D::OnRender()
	{
		...
		Renderer renderer; 
		m_Proj = glm::ortho(0.f, (float)*m_WindowWidthPtr, 0.f, (float)*m_WindowHeightPtr, -1.0f, 1.0f);
		{
